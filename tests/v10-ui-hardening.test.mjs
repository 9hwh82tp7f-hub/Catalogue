...
assert.match(html, /<button type="button" class="modal-close" id="modalClose"/, 'La fermeture de fiche produit doit être un vrai bouton tactile/accessibile.');
...
assert.match(sw, /CACHE_NAME = CACHE_PREFIX \+ 'v10\.2-20260814-ui2'/, 'Le cache local doit être invalidé après la passe UI.');
