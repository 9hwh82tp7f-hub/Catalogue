/* Service Worker — catalogue Telegram — V10.2 */
const CACHE_PREFIX = 'catalogue-cache-';
const CACHE_NAME = CACHE_PREFIX + 'v10.2';
const APP_SHELL = ['./index.html', './manifest.json', './assets/icons/icon-192.png', './assets/icons/icon-512.png', './premium-3d.css', './premium-runtime.js'];
