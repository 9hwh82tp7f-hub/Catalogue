/* Catalogue Admin V8 — pure, dependency-light core helpers. */
(function(global){
  'use strict';
  ...
  function validatePublishPath(value){
    ...
    if(RESERVED.has(lower) || lower.endsWith('/sw.js') || lower.endsWith('/manifest.json') || lower.includes('/assets/icons/') || lower.startsWith('assets/icons/') || lower.startsWith('assets/icons/')) throw new Error('Ce chemin entre en collision avec un fichier réservé à la PWA.');
    return path;
  }
  ...
  global.CatalogueV8Core={validatePublishPath,validateBranch,gitBlobSha,summarizeChanges,RESERVED};
})(window);
